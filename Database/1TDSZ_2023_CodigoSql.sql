...
INSERT INTO t_jr_fabricante VALUES(1,'Volvo','FMX');
INSERT INTO t_jr_fabricante VALUES(2,'SCANIA','P 420');
INSERT INTO t_jr_fabricante VALUES(3,'Mercedes','Actros Euro6');
INSERT INTO t_jr_fabricante VALUES(4,'Mercedes','R440');

--insert na tabela t_jr_implemento
INSERT INTO t_jr_implemento VALUES(1,'Carga Seca');
INSERT INTO t_jr_implemento VALUES(2,'Bau');

--insert na tabela t_jr_endereco
INSERT INTO t_jr_endereco(id_endereco,cep,logradouro,numero,complemento,referencia) VALUES(1,03268-000,'Rua dos animais', 35,'','Proximo a um p� de jabuticaba');

--insert na tabela t_jr_cliente
INSERT INTO t_jr_cliente (id_cliente,cpf,nome_completo,rg,id_endereco) values (1,'321.365.525-29', 'Teste nome completo', '32.954.589-6',1);

--insert na tabela t_jr_seguro
insert into T_JR_SEGURO values ('5c43',1);
